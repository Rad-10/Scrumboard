...
const getCSSModuleLocalIdent = require('react-dev-utils/getCSSModuleLocalIdent.js');
const ModuleNotFoundPlugin = require('react-dev-utils/ModuleNotFoundPlugin.js');
...
module.exports = (
  ...
  return {
    ...
    output: {
      // The build folder.
      //path: paths.appBuild,
      //path: resolveApp('dist/components'),
      path: appBuild,
