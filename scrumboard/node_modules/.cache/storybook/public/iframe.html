    ...
    xhr.send(
      ...
      #docs-root[hidden] {
        display: none !important;
            ...
            window['SERVER_CHANNEL_URL'] = "ws://localhost:6040/storybook-server-channel";</script><script src="runtime~main.iframe.bundle.js"></script><script src="vendors-node_modules_pega_cosmos-react-core_lib_components_Modal_ModalManager_js-node_modules-e1013c.iframe.bundle.js"></script><script src="main.iframe.bundle.js"></script></body></html>